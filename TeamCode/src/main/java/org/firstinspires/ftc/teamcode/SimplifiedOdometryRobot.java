...
public class SimplifiedOdometryRobot {
    ...
    //  the Axial (front/back) Odometry Module (may overlap with motor, or may not)
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        odo = myOpMode.hardwareMap.get(GoBildaPinpointDriverRR.class,"pinpoint");
        odo.setOffsets(-2.25, 0); //TODO i dont this this is rrigh
